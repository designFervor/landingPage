                            ...
                            isVideoAnimationShow ?
                                ...
                                <div className="img-wrapper">
                                    <div className="img-box" data-animation="fade-zoom-in" data-delay={0.1}>
                                        <Image width={524} height={655} sizes='100vw' className="image-box-item" src="/img/all-img/pricing-image-2.png" alt="image" />
                                        <Image width={524} height={655} sizes='100vw' className="image-box-item" src="/img/all-img/pricing-image.png" alt="image" />
                                    </div>
                                </div>
                        }
                    </div>
